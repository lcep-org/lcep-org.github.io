...
<div class="row mt-3">
    ...
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid class="scale" loading="eager" path="assets/img/space_vis_lab.JPG" class="img-fluid rounded z-depth-1" caption="The students explore Adler Planetarium's Space Visualization Lab with Prof. Aaron Geller, March 2019" zoomable=true %}
    </div>
</div>